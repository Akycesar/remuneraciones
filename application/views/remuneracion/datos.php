...
function verifysub(){
  var rut = $('#rut').val();
  var ap_pa = $('#apellido_paterno').val();
  var ap_ma = $('#apellido_materno').val();
  var nom = $('#nombres').val();
  ...
  if(rut.length>0){
    ...
    $('#mensaje').html('<p class="alert alert-warning">Rellene Los campos.</p>');
  }
}
</script>
<section id="content">
<div class="tile">
  ...
  <div class="row">
    <div class="col-md-8">
      <?// formulario ?>
      <form name="empleado" action="crearEmpleado" method="post">
        <div class="row">
              <div class="col-md-4">  Empresa Activa:</div>
              <div class="col-md-4"><input type="text" class="form-control" id="rs" name="rs" value="<?= $rs ?>" readonly> </div>
              <div class="col-md-4"><input type="hidden" class="form-control" id="rut_empresa" name="rut_empresa" value="<?= $rut_empresa ?>" readonly></div>
          </div>
          <div class="row">
              <div class="col-md-4">  RUT:</div>
              <div class="col-md-4"><input type="text" name="rut" id="rut" class="form-control" placeholder="Formato 12345678-9" autocomplete="off" onblur="verificarRut()" required></div>
          ...
          <div class="row">
              ...
              <div class="col-md-4"><input type="text" name="apellido_paterno" id="apellido_paterno" class="form-control" autocomplete="off" required></div>
          ...
          <div class="row">
              ...
              <div class="col-md-4"><input type="text" name="apellido_materno" id="apellido_materno" class="form-control" autocomplete="off" required></div>
              <div class="col-md-4"></div>
          </div>
          <div class="row">
              <div class="col-md-4">  Nombres:</div>
              <div class="col-md-4"><input type="text" name="nombres" id="nombres" class="form-control" autocomplete="off" required></div>
              <div class="col-md-4"></div>
          </div>
          <div class="row">
              <div class="col-md-4">  Fecha Nacimiento:</div>
              <div class="col-md-4"><input type="text" name="fecha_nacimiento" id="fecha_nacimiento" class="form-control" placeholder="dd-mm-YY" autocomplete="off" required></div>
    ...
    <div class="col-md-2"></br></br><button class="btn btn-primary btn-info btn-block" onClick="verifysub()">Guardar</button></div>
  </div>
</div>
    <div class="tile">
      <div class="row">
        <div class="col-md-10"> <?// formulario ?>
          <div class="panel panel-primary">
            <div class="t-header">
              ...
              <div class="row">
                  <div class="col-md-2">  Fecha Contrato:</div>
                  <div class="col-md-4"><input type="text" class="form-control" name="fecha_contrato" id="fecha_contrato" placeholder="dd-mm-YY" autocomplete="off" required></div>
                  <div class="col-md-2">  Sueldo Base:</div>
                  <div class="col-md-4"><input class="form-control" name="sbase" id="sbase" placeholder="Sueldo Base"></div>
              </div>
              <div class="row">
                  <div class="col-md-2">  Fecha Termino:</div>
                  ...
                  <div class="col-md-2">  Contrato:</div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-2">  Horario Trabajo:</div>
                  <div class="col-md-4"><input class="form-control" name="horario" id="horario" placeholder="Horario de trabajo"></div>
              </div>
              <div class="row">
                  ...
                  <div class="col-md-2">  Colacion:</div>
                  <div class="col-md-4"><input class="form-control" name="horario_colacion" id="horario_colacion" placeholder="Horario de colacion"></div>
              </div>
              <div class="row">
                  <div class="col-md-2"></div>
                  <div class="col-md-4"><input type="checkbox" id="sindicalizado"> Sindicalizado</div>
                  <div class="col-md-2">  Ingreso Sindicato:</div>
              ...
              <div class="row">
                <div class="col-md-2">  Tipo de Contrato</div>
                <div class="col-md-4"><select name="contrato_doc" id="contrato_doc" class="form-control"><option>Normal</option><option>Articulo 22</option></select></div>
                <div class="col-md-2"></div>
                <div class="col-md-4"></div>
              </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                 ...
                 <div class="row">
                  ...
                  <div class="row">
                    selecciona si quieres que te paguen por tranfer logi
                  </div>
                </br>
                  <div class="row">
                    <div class="col-md-6" id="mensajeper"></div>
                    <div class="col-md-6"><button class="btn btn-primary pull-right" onClick="crearDpersonales()">Guardar</button></div>
                  </div>
                </div>
                <div class="modal-footer">
                    <div class="btn-group">

...
<section id="content">  
    ...
    <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
        ...
        <div class="row">                
             <center><img src="http://remuneracion.ingetecservice.cl/remuneracion/application/img/security.png" width="300px" heigth="200px"></center>
        </div>
        
        <div class="panel panel-default" >
            <div class="panel-heading">
                <div class="panel-title text-center">Actualización de datos de Acceso.</div>
            </div>     
            ...
            <div class="panel-body" >
                ...
                <form name="form" id="form" class="form-horizontal" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span><input type="hidden" value="<?= $usuario ?>" id="lastuser">
                        <input id="user" type="text" class="form-control" name="user" value="<?= $usuario ?>" placeholder="Usuario" autocomplete="off">
                        <span class="input-group-btn"><button class="btn btn-primary" type="button" onClick="actualizarUsuario()">Actualizar</button></span>                                         
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                        <input id="password1" type="password" class="form-control" name="password1" placeholder="Clave" autocomplete="off"> 
                    </div> 
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                        <input id="password2" type="password" class="form-control" name="password2" placeholder="Repita la Clave" autocomplete="off">  
                    	<span class="input-group-btn"><button class="btn btn-primary" type="button" onClick="actualizarClave()">Actualizar</button></span>
                    </div> 
                </form>     
               <div class="col-md-12" id="mensajeUser"></div>
            </div>                     
        </div>  
    </div>
</section>

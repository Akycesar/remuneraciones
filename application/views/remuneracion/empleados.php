...
<section id="content">
            <div class="container">
            <div class="heading"><h3>Empleados</h3></div>       
            <div class="tile">
                    ...
                    <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $value->nombres ?></td>
                                <td><?= $value->empresa ?></td>
                                <td><center><button title="Perfil" class="btn btn-primary" onClick="location.href='perfil/<?= $value->rut ?>'"><li class="zmdi zmdi-eye"></li></button> <button title="Editar" class="btn btn-info" onClick="location.href='editar/<?= $value->rut ?>'"><li class="zmdi zmdi-edit"></li></button> <button title="Eliminar" class="btn btn-warning sweet-13" onclick="sure(<?= $cont ?>)"><li class="zmdi zmdi-delete"></li></button> <button title="Liquidaciones" class="btn btn-success sweet-13" onclick="location.href='listLiq/<?= $value->rut ?>'"><li class="zmdi zmdi-file-text"></li></button> <button title="Ex-empleado" class="btn btn-danger sweet-13" onclick="sure2(<?= $cont ?>)"><li class="zmdi zmdi-lock"></li></button> <button title="Contrato" class="btn btn-primary sweet-13" onclick="window.open('contrato/<?= $value->rut ?>')"><li class="zmdi zmdi-file-text"></li></button></center></td>
                            </tr>
                            <? $cont=$cont+1; } } ?>
                        </tbody>
                    </table>
